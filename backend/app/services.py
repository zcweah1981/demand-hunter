...
DEFAULT_SETTINGS = {
    ...
    "AUTO_RUN_LIMIT": "6",
    "AUTOMATION_CYCLE_MAX_SECONDS": "300",
    "AUTOMATION_CYCLE_BUDGET_JSON": "{}",
    "AUTOMATION_SOURCE_FLAGS_JSON": "{}",
    "AUTOMATION_REPAIR_BEHAVIOR": "suggest_only",
    ...
    "HIGH_RISK_ACTION_POLICY": "suggest_only",
    "SOURCE_BUDGET_JSON": "{}",
