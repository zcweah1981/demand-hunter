...
const names:any={'api-keys':'API Key 管理中心',search:'searchProviders',searxng:'SearXNG',brave:'Brave',tavily:'Tavily',llm:'LLM',automation:'automation',quality:'quality',security:'security'}
