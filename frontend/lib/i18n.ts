...
const dict:Record<string,Record<Lang,string>>={
 autopilot:{zh:'自动猎手',en:'Autopilot'}, overview:{zh:'概览',en:'Overview'}, discovery:{zh:'四找发现',en:'Discovery'}, dashboard:{zh:'仪表盘',en:'Dashboard'}, review:{zh:'复核',en:'Review'}, cards:{zh:'机会卡',en:'Cards'}, keywords:{zh:'关键词',en:'Keywords'}, roots:{zh:'词根库',en:'Root Library'}, runs:{zh:'运行历史',en:'Run History'}, settings:{zh:'设置',en:'Settings'}, advanced:{zh:'高级',en:'Advanced'},
